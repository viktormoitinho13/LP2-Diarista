...
<body>
  ...
  ?>
    ...
    <div id="Registros">
      <br />
      ID: <input type="text" value="<?php echo $linha['id'] ?> " readonly></br>
      ...
      <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
      Sobrenome: <input type="text" value="<?php echo $linha['sobrenome'] ?> " readonly></br>
      <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
      Endereco: <input type="text" value="<?php echo $linha['endereco'] ?> " readonly></br>
      <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
      Salario: <input type="text" value="<?php echo $linha['salario'] ?> " readonly></br></br>
      <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
