  ...
  ?>
    ...
    <div id="Registros">
      ...
      <form action="editarRegistro.php" method="POST">
        ...
        Nome: <input type="text" name="editarNome" value="<?php echo $linha['nome'] ?> "></br>
        <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
        Sobrenome: <input type="text" name="editarSobre" value="<?php echo $linha['sobrenome'] ?> "></br>
        <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
        Endereco: <input type="text" name="editarEndereco" value="<?php echo $linha['endereco'] ?> "></br>
        <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
        Salario: <input type="text" name="editarSalario" value="<?php echo $linha['salario'] ?> "></br></br>
        <!--Cria um campo input para guardar o valor que foi buscado no banco de dados -->
